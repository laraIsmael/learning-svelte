<script lang="ts">
// this is the first version of +page.svelte saved here so we can keep coding on the actual file.
// this code focus on the basic of $state and $props along side file Header.svelte 
